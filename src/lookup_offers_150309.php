		    ...
		    <div class="medium-6 columns">
				...
				?>
					...
					<div class="row collapse">
					  <div class="js-masonry" id="mycontainer" data-masonry-options='{ "columnWidth": 50%, "itemSelector": ".item" }'>
						<div class="nopadding">
						...
						<?
							...
							foreach($rows as $row)
							{
								...
								echo '<a href="offer_details.php?od='.$oid.'" class="item">';
								...
								if($i == 2)
								{
									echo "<p>&nbsp;</p></div><div class=' nopadding vbottomspace'>";
									$i=0;
								}
							}
							if($j == 0)
					...
					<div class="row collapse">
						...
						<?
							...
							foreach($rows as $row)
							{
								...
								echo '<div class="medium-6 columns" style="padding:5px 0">';
