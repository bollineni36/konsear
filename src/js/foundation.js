...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.joyride = {
    ...
    defaults : {
      ...
      start_timer_on_click    : false,      // true or false - true requires clicking the first button start the timer
      start_offset          : 0,         // the index of the tooltip you want to start on (index of the li)
      next_button           : false,      // true or false to control whether a next button is used
