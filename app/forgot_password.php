	...
	$db = new VDatabase(true);
		...
		if(isset($_POST['submit']))
		{
			...
			if($message == ""){
				...
				$query = sprintf("SELECT PublisherId, PublisherName, PublisherDbaName, PublisherContactName, PublisherPassword, PublisherEmailId, PublisherActiveFlag, PublisherPlanId FROM %s%s WHERE PublisherEmailId = '%s' AND PublisherActiveFlag='Active'", DB_PREFIX, PUBLISHER_TABLE, $email);
