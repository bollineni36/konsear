...
<div id="header">
  ...
  <!--<h2><a href="<?php echo esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>"><?php bloginfo('name'); ?></a></h2>-->
   <h2><a href="<?php echo esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>" style="background: #ffffff;"><?php //bloginfo('name'); ?><img src="<?php echo esc_url(home_url('/')); ?>wp-content/uploads/2014/06/logok.png"></a></h2>
